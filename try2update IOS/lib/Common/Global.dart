...
void showToastRed(String msg) {
  Fluttertoast.showToast(
      ...
      backgroundColor: Color(0xffff0000).withOpacity(0.8),
...
void showToastGreen(String msg) {
  Fluttertoast.showToast(
      ...
      gravity: ToastGravity.BOTTOM,
      timeInSecForIosWeb: 1,
      backgroundColor: Color(0xff4CAF50).withOpacity(0.8),
      textColor: Color(0xffffffff),
      fontSize: 16.0);
}


void showToastMyDec(String msg) {
  Fluttertoast.showToast(
      msg: msg,
      toastLength: Toast.LENGTH_SHORT,
      gravity: ToastGravity.BOTTOM,
      timeInSecForIosWeb: 1,
      backgroundColor: Color(0x90af7390).withOpacity(0.8),
      textColor: Color(0xffffffff),
      fontSize: 16.0);
}
...
class Global {
  ...
  static bool encryptionValue = true;
  // 是否开启加密
  static bool decryptionValue = true;
  // 是否（显示）解密后的数据

  static bool colorDecoration = true;
  ...
  static Future init() async {
    ...
    LeanCloud.initialize(
        'vLjk73Kg9j1qWLs8yI8PUn61-gzGzoHsz', 'QGpcS9G0SD2KJOaqSpC99mjY',
        server: 'https://vljk73kg.lc-cn-n1-shared.com',
