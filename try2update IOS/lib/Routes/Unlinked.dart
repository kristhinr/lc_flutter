...
class Unlinked extends StatefulWidget {
  @override
  _UnlinkedState createState() => new _UnlinkedState();
}

class _UnlinkedState extends State<Unlinked> {
                  ...
                  delegate: SliverChildBuilderDelegate(
                    (context, index) {
                      ...
                      if (unreadCountMap[con.id] != null) {
                        ...
                        bool value =(!allClients().contains(creater) &&
                      creater != Global.clientID &&
                      count == 2);
                      bool isGroup =false;
